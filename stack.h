...
typedef enum {
  CHAR, /**< representação do tipo char */
  INT, /**< representação do tipo int */
  STR, /**< representação do tipo "string" */
  LNG, /**< representação do tipo long */
  DBL, /**< representação do tipo double */
  BLOCO, /**< representação do tipo "bloco"(string) */
  ARRAY /**< representação do tipo "array"(stack) */
}type;
...
typedef struct stack_Elem{
  type t; /**< tipo que o elemento tem--> vem do enum apresentado anteriormente */
  union{
    char c; /**< espaço alocado para um char */
    int i; /**< espaço alocado para um int */
    char *str; /**< espaço alocado para uma "string" */
    char *bloco; /**< espaço alocado para um "bloco" */
    long l; /**< espaço alocado para um long */
    double d; /**< espaço alocado para um double */
    struct STACK* array; /**< espaço alocado para um "array" */
  }saved_Value; /**< conteúdo do elemento(poderá corresponder a qualquer uma das opções acima definidas) */
}stack_Elem;
...
typedef struct STACK{
  stack_Elem *stack; /**< lista de stack_Elems que constituirá a stack */
  int sp; /**< stack pointer --> valor igual à posição do elemento do topo da stack */
  int capacidade; /**< capacidade que a stack possui (quantidade máxima de stack_Elems que pode conter) */
}STACK;
